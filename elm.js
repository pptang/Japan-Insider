					...
					if (behaviour.$ === 'Next') {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									serviceIndex: A2(author$project$Main$nextIndex, model.serviceIndex, author$project$Main$successCaseCarouselLength)
								}),
							elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									serviceIndex: A2(author$project$Main$prevIndex, model.serviceIndex, author$project$Main$successCaseCarouselLength)
								}),
							elm$core$Platform$Cmd$none);
					}
				}
