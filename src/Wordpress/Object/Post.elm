...
module Wordpress.Object.Post exposing (AncestorsOptionalArguments, CategoriesOptionalArguments, CommentsOptionalArguments, ContentOptionalArguments, ExcerptOptionalArguments, TagsOptionalArguments, TermNamesOptionalArguments, TermSlugsOptionalArguments, TermsOptionalArguments, TitleOptionalArguments, ancestors, author, categories, commentCount, commentStatus, comments, content, date, dateGmt, desiredSlug, editLast, editLock, enclosure, excerpt, featuredImage, guid, id, link, menuOrder, modified, modifiedGmt, parent, pingStatus, pinged, postId, slug, status, tags, termNames, termSlugs, terms, title, toPing, uri)
...
-}
ancestors : (AncestorsOptionalArguments -> AncestorsOptionalArguments) -> SelectionSet decodesTo Wordpress.Union.PostObjectUnion -> SelectionSet (Maybe (List (Maybe decodesTo))) Wordpress.Object.Post
...
-}
author : SelectionSet decodesTo Wordpress.Object.User -> SelectionSet (Maybe decodesTo) Wordpress.Object.Post
author object_ =
...
type alias CategoriesOptionalArguments =
    ...
    , where_ : OptionalArgument Wordpress.InputObject.PostToCategoryConnectionWhereArgs
    }
...
-}
categories : (CategoriesOptionalArguments -> CategoriesOptionalArguments) -> SelectionSet decodesTo Wordpress.Object.PostToCategoryConnection -> SelectionSet (Maybe decodesTo) Wordpress.Object.Post
categories fillInOptionals object_ =
    let
        ...
        optionalArgs =
            [ Argument.optional "first" filledInOptionals.first Encode.int, Argument.optional "last" filledInOptionals.last Encode.int, Argument.optional "after" filledInOptionals.after Encode.string, Argument.optional "before" filledInOptionals.before Encode.string, Argument.optional "where" filledInOptionals.where_ Wordpress.InputObject.encodePostToCategoryConnectionWhereArgs ]
                |> List.filterMap identity
    in
...
-}
commentCount : SelectionSet (Maybe Int) Wordpress.Object.Post
commentCount =
...
type alias CommentsOptionalArguments =
    ...
    , after : OptionalArgument String
    , before : OptionalArgument String
    , where_ : OptionalArgument Wordpress.InputObject.PostToCommentConnectionWhereArgs
    }
...
-}
comments : (CommentsOptionalArguments -> CommentsOptionalArguments) -> SelectionSet decodesTo Wordpress.Object.PostToCommentConnection -> SelectionSet (Maybe decodesTo) Wordpress.Object.Post
comments fillInOptionals object_ =
    let
        ...
        optionalArgs =
            [ Argument.optional "first" filledInOptionals.first Encode.int, Argument.optional "last" filledInOptionals.last Encode.int, Argument.optional "after" filledInOptionals.after Encode.string, Argument.optional "before" filledInOptionals.before Encode.string, Argument.optional "where" filledInOptionals.where_ Wordpress.InputObject.encodePostToCommentConnectionWhereArgs ]
                |> List.filterMap identity
    in
...
-}
commentStatus : SelectionSet (Maybe String) Wordpress.Object.Post
commentStatus =
...
-}
content : (ContentOptionalArguments -> ContentOptionalArguments) -> SelectionSet (Maybe String) Wordpress.Object.Post
...
-}
date : SelectionSet (Maybe String) Wordpress.Object.Post
date =
...
-}
dateGmt : SelectionSet (Maybe String) Wordpress.Object.Post
dateGmt =
...
-}
desiredSlug : SelectionSet (Maybe String) Wordpress.Object.Post
desiredSlug =
...
-}
editLast : SelectionSet decodesTo Wordpress.Object.User -> SelectionSet (Maybe decodesTo) Wordpress.Object.Post
editLast object_ =
...
-}
editLock : SelectionSet decodesTo Wordpress.Object.EditLock -> SelectionSet (Maybe decodesTo) Wordpress.Object.Post
editLock object_ =
...
-}
enclosure : SelectionSet (Maybe String) Wordpress.Object.Post
enclosure =
...
-}
excerpt : (ExcerptOptionalArguments -> ExcerptOptionalArguments) -> SelectionSet (Maybe String) Wordpress.Object.Post
...
-}
featuredImage : SelectionSet decodesTo Wordpress.Object.MediaItem -> SelectionSet (Maybe decodesTo) Wordpress.Object.Post
...
-}
guid : SelectionSet (Maybe String) Wordpress.Object.Post
guid =
...
-}
id : SelectionSet Wordpress.ScalarCodecs.Id Wordpress.Object.Post
id =
...
-}
link : SelectionSet (Maybe String) Wordpress.Object.Post
link =
...
-}
menuOrder : SelectionSet (Maybe Int) Wordpress.Object.Post
menuOrder =
...
-}
modified : SelectionSet (Maybe String) Wordpress.Object.Post
modified =
...
-}
modifiedGmt : SelectionSet (Maybe String) Wordpress.Object.Post
modifiedGmt =
...
-}
parent : SelectionSet decodesTo Wordpress.Union.PostObjectUnion -> SelectionSet (Maybe decodesTo) Wordpress.Object.Post
parent object_ =
...
-}
pinged : SelectionSet (Maybe (List (Maybe String))) Wordpress.Object.Post
pinged =
...
-}
pingStatus : SelectionSet (Maybe String) Wordpress.Object.Post
pingStatus =
...
-}
postId : SelectionSet Int Wordpress.Object.Post
postId =
...
-}
slug : SelectionSet (Maybe String) Wordpress.Object.Post
slug =
...
-}
status : SelectionSet (Maybe String) Wordpress.Object.Post
status =
...
type alias TagsOptionalArguments =
    ...
    , after : OptionalArgument String
    , before : OptionalArgument String
    , where_ : OptionalArgument Wordpress.InputObject.PostToTagConnectionWhereArgs
    }
...
-}
tags : (TagsOptionalArguments -> TagsOptionalArguments) -> SelectionSet decodesTo Wordpress.Object.PostToTagConnection -> SelectionSet (Maybe decodesTo) Wordpress.Object.Post
tags fillInOptionals object_ =
    let
        ...
        optionalArgs =
            [ Argument.optional "first" filledInOptionals.first Encode.int, Argument.optional "last" filledInOptionals.last Encode.int, Argument.optional "after" filledInOptionals.after Encode.string, Argument.optional "before" filledInOptionals.before Encode.string, Argument.optional "where" filledInOptionals.where_ Wordpress.InputObject.encodePostToTagConnectionWhereArgs ]
                |> List.filterMap identity
    in
...
-}
termNames : (TermNamesOptionalArguments -> TermNamesOptionalArguments) -> SelectionSet (Maybe (List (Maybe String))) Wordpress.Object.Post
...
-}
terms : (TermsOptionalArguments -> TermsOptionalArguments) -> SelectionSet decodesTo Wordpress.Union.TermObjectUnion -> SelectionSet (Maybe (List (Maybe decodesTo))) Wordpress.Object.Post
...
-}
termSlugs : (TermSlugsOptionalArguments -> TermSlugsOptionalArguments) -> SelectionSet (Maybe (List (Maybe String))) Wordpress.Object.Post
...
-}
title : (TitleOptionalArguments -> TitleOptionalArguments) -> SelectionSet (Maybe String) Wordpress.Object.Post
...
-}
toPing : SelectionSet (Maybe (List (Maybe String))) Wordpress.Object.Post
toPing =
...
-}
uri : SelectionSet (Maybe String) Wordpress.Object.Post
uri =
