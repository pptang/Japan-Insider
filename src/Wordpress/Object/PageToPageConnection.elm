...
module Wordpress.Object.PageToPageConnection exposing (edges, nodes, pageInfo, postTypeInfo)
...
-}
edges : SelectionSet decodesTo Wordpress.Object.PageToPageConnectionEdge -> SelectionSet (Maybe (List (Maybe decodesTo))) Wordpress.Object.PageToPageConnection
edges object_ =
...
-}
nodes : SelectionSet decodesTo Wordpress.Object.Page -> SelectionSet (Maybe (List (Maybe decodesTo))) Wordpress.Object.PageToPageConnection
nodes object_ =
...
-}
pageInfo : SelectionSet decodesTo Wordpress.Object.WPPageInfo -> SelectionSet (Maybe decodesTo) Wordpress.Object.PageToPageConnection
pageInfo object_ =
...
-}
postTypeInfo : SelectionSet decodesTo Wordpress.Object.PostType -> SelectionSet (Maybe decodesTo) Wordpress.Object.PageToPageConnection
