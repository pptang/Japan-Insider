...
module Wordpress.Enum.PostStatusEnum exposing (PostStatusEnum(..), decoder, fromString, list, toString)
...
{-| The status of the object.
  ...
  - AcfDisabled - Objects with the acf-disabled status
...
list =
    [ AcfDisabled, AutoDraft, Draft, Future, Inherit, Pending, Private, Publish, RequestCompleted, RequestConfirmed, RequestFailed, RequestPending, Trash ]
